...
func (in *DremioProperties) DeepCopyInto(out *DremioProperties) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DremioProperties.
func (in *DremioProperties) DeepCopy() *DremioProperties {
	if in == nil {
		return nil
	}
	out := new(DremioProperties)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DremioRestServerSpec) DeepCopyInto(out *DremioRestServerSpec) {
	*out = *in
	out.Dremio = in.Dremio
	out.ContainerLimits = in.ContainerLimits
	out.ContainerRequests = in.ContainerRequests
}
